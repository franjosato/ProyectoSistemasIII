...
Public Class mdi_Corredor
    ...
    Private Sub ContratoDePólizaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ContratoDePólizaToolStripMenuItem.Click
    ...
    Private Sub TomadorToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TomadorToolStripMenuItem.Click
        frm_Tomador.Show()
    End Sub
    ...
    Private Sub PlanDePagoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PlanDePagoToolStripMenuItem.Click
        frm_Plan_Pago.Show()
    End Sub
